...
export default class Game {
    ...
    constructor(scene: Scene, world: World, camera: PerspectiveCamera, controls: OrbitControls, gltfLoader: GLTFLoader, textureLoader: TextureLoader, raycaster: Raycaster) {
        this.scene = scene
        this.world = world
        this.camera = camera
        ...
        this.ui = new UI(this.controls, this.camera, this.car, this.players, this.socket)
        ...
        this.socket.on('joined', (id: string, screenName: string, recentWinners: []) => {
            this.myId = id
        ...
        const terrainLoaded = () => {
            this.start = new Start(this.scene, this.world, this.gltfLoader, this.textureLoader, this.car.frameBody.id, this.ui, this.socket)
            this.finish = new Finish(this.scene, this.gltfLoader, this.textureLoader)
            ...
            this.boulders = new Boulders(this.scene, this.world, this.terrain, 25, this.textureLoader, this.raycaster, nextRandom)
        ...
        this.terrain = new Terrain(scene, world, gltfLoader, textureLoader, raycaster, terrainLoaded)
    }
